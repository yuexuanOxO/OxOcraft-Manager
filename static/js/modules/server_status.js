...
function renderPlayersFromQuery(players) {
    ...
    players.forEach(player => {
        ...
        const playerData = {
            ...
            name: playerName,
            account_type: playerAccountType,
            online: true,
        };
        ...
        avatar.src = getPlayerAvatarUrl(playerData);
        ...
        const menuWrap = createPlayerListMenu(playerData);
